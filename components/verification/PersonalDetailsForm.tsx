...
const PersonalDetailsForm: React.FC<PersonalDetailsFormProps> = ({ initialValues, onSubmit }) => {
  ...
  return (
    <div className="mb-8 sm:mb-10">
      <h2 className="text-xl font-bold tracking-tighter text-black mb-6">Details</h2>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className="h-11 rounded-xl border border-gray-300 bg-gray-50 px-4 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent"
          ...
          <div className="flex flex-col">
            ...
            <div className="relative">
              <input
                ...
                className="h-11 w-full rounded-xl border border-gray-300 bg-gray-50 px-4 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent"
                required
              />
              <button
                type="button"
          ...
          <div className="flex flex-col">
            ...
            <div className="flex h-11 rounded-xl border border-gray-300 bg-gray-50 overflow-hidden">
          ...
          <div className="flex flex-col">
            ...
            <div className="relative">
              <select
                ...
                onChange={handleChange}
                className="h-11 w-full rounded-xl border border-gray-300 bg-gray-50 px-4 appearance-none focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent"
                required
              >
        ...
        <div className="mt-6">
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full h-11 rounded-xl border border-gray-300 bg-gray-50 px-4 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent"
