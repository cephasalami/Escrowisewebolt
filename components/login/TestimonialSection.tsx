    ...
    <article className="h-full w-full flex flex-col relative p-8 sm:p-12 lg:p-16">
      ...
      <div className="flex-grow">
        ...
        <blockquote className="text-lg sm:text-xl lg:text-2xl font-bold tracking-tighter text-black leading-tight mb-8 sm:mb-10 lg:mb-12 max-w-[500px]">
          "I run an online marketplace, and handling large transactions was always a challenge. With Escrowise, buyers
          and sellers feel secure, and disputes have dropped significantly. It's a game-changer for trust in digital
          commerce!"
        </blockquote>
        ...
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full overflow-hidden flex-shrink-0">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/istockphoto-2162937006-612x612-6BIr050bas1QgwjO5PIU8mbCeDIJLd.png"
              alt="Sophia L. profile"
              className="w-full h-full object-cover"
            />
          </div>
          <div>
            <h3 className="text-base sm:text-lg lg:text-xl font-bold tracking-tighter text-black">Sophia L.</h3>
            <p className="text-xs sm:text-sm tracking-tighter text-black opacity-80">Founder of NexaTrade</p>
          </div>
        </div>
      </div>
